...
__We are 95% confident that the difference in proportion of Oregonians who reported insufficient sleep to Californians is between -.174% (negative indicating that Californians reported more insufficient sleep) and 1.74%.__
...
```{r}
r <- c(4, 16, 67, 345, 426)
v <- c("Woods", "Cultivated grassplot", "Deciduous forests", "Other", "Total")
df <- rbind(v, r)
knitr::kable(df)
```

...
While we see there about 305 unique Super PACs associated with HRC and DJT, apparently many of them cannot spell or use multiple submitters to send reports to the FEC.   There are a number of duplicate records in here, but a quick scan suggests maybe 20-40 are dupes.   Cleaning this field is beyond the scope of this project. 

...
2.  The title of the report is "Global Index of Religiosity and Atheism". To
    ...
    __We must assume the observations are independent, and the sample is random.__  
...
3.  What does each row of Table 6 correspond to? What does each row of 
    ...
    __Each row of the table is the summary of responses per country.   Each row of the atheism DF is an individual response.__
...
5.  Write out the conditions for inference to construct a 95% confidence
    ...
    __We need the observations to be independant and each part of the proportion to be sufficiently large.   There are 50 atheist counts, so both conditions are satisfied.__
...
6.  Based on the R output, what is the margin of error for the estimate of the 
    ...
    __The margin of error is 1.35%.__ 
...
#confirm conditions for inference are met
...
__The margin of error for Brazil is .44% and the margin of error for Japan is 2.59%__
...
__This is a very helpful way to visualize the relationship between proportion and margin of error.  When large numbers of the proportion lean in one direction or the other, the margin of error decreases, as the halves of the proportion near each other, the margin of error is at its apex.__
...
__As expected n increases the height/size and decreases spread or variability.   All plots are nearly normal.__ 
...
__It should be fine to proceed with inference in Austrailia, but the sample in Ecuador does not meet our inference standards.   .02 of 400 = 8.__
...
$H_0:$ There is no difference between the atheism index in Spain from 2005 to 2012. 
$H_A:$ There is a difference between the atheism index in Spain from 2005 to 2012. 
...
__We accept $H_0$.   There is not convincing evidence there is a difference in the atheism index in Spain from 2005 - 2012.__


    **b.** Is there convincing evidence that the United States has seen a
    change in its atheism index between 2005 and 2012?
    
$H_0:$ There is no difference between the atheism index in US from 2005 to 2012. 
$H_A:$ There is a difference between the atheism index in US from 2005 to 2012. 
...
__There is convincing evidence that the is a difference in index.   We reject the null hypthesis. NOTE:   Our 2005 sample just cleared the "10" in the atheist proportion. Be careful with generalizations.__
...
__We would expect to see a change simply by chance in `r 39 * .05` (or 2) countries.__
...
__Since we do not know what either p or n is, in order to make sure we are within the requested guidelines, we should consider the population proportion with the largest potential me - .5.   Then we can simply work backwards to find that we should get a sample of `r n` people.__

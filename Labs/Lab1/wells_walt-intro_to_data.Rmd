...
```{r}
## The mosaic plot reveals that the greatest proportion of individuals who have not smoked more than 100 cigarettes are females.
```
...
### Here we have plotted the relationship between BMI and respondants who said they had exercised at least once in the last month.  We might expect there to be a relationship between the two, but there are so many additional contributing factors involved (eg. recently started exercising because BMI was getting too high, etc), that this boxplot does not easily help us draw conclusions about a relationship between the two.   

##We can say that while there appear to be greater outliers in the BMI of those who have exercised in the past month, the IQC seems to show considerably less variance and a lower median BMI.    
```

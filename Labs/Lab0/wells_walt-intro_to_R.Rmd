...
plot(present$year, present$boys/present$girls, xlab="Year", 
     ylab="Ratio of Boys to Girls", main="Ratio of Boy to Girl Births,
     1940-2002")
...
We can see that the year with the maximum total births in the US was `r maxyr` with `r as.integer(max)` total births.
